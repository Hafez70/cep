    ...
    if (__a === "!") {
        ...
        try {
            ...
            var data = $http({
                ...
                //url: 'http://localhost:9945/api/lic/check/' + homeStr
                });
        ...
        if (canWriteFiles()) {
            ...
            try {
                var data = $http({
                    ...
                    //url: 'http://localhost:9945/api/lic/activate/' + homeStr
                });
            }
            catch (e) {
...
function logOut() {
    try {
        var settingPath = getpathFromSetting();
        var machiatochi = getMachinId(settingPath);
        var homeStr = backtohome(getACodeFromSetting() + '|' + machiatochi);
        ...
        try {
            var data = $http({
                method: 'GET',
                url: 'http://wondertools-official.com/api/lic/deactivebc/' + homeStr
                //url: 'http://localhost:9945/api/lic/deactivebc/' + homeStr
            });
            return JSON.stringify({ err: false, msg: '' });
        }
        catch (e) {
